    ...
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('register')}}" method="POST">
                @csrf
                <div class="mb-5">
                    <label for="titulo" class="md-2 block uppercase text-gray-500 fond-bold">Titulo</label>
                ...
                <div class="mb-5">
                    <label for="descripcion" class="md-2 block uppercase text-gray-500 fond-bold">Descripcion</label>
